...
<figure class="gif-card">
  <img src={`${import.meta.env.BASE_URL}/gifs/Abbey_POI_Completion.gif`} alt="POI Completion" />
...
<figure class="gif-card">
  <img src={`${import.meta.env.BASE_URL}/gifs/Abbey_POI_Tracking.gif`} alt="POI Completion" />
