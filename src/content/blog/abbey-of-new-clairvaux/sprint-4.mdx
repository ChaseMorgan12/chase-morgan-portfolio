...
<figure class="gif-card">
  <img src={`${import.meta.env.BASE_URL}/gifs/Abbey_Full_Object_Detection.gif`} alt="Full Object Detection" />
...
<figure class="gif-card">
  <img src={`${import.meta.env.BASE_URL}/gifs/Abbey_Bounding_Boxes.gif`} alt="Bounding Boxes" />
...
<figure class="gif-card">
  <img src={`${import.meta.env.BASE_URL}/gifs/Abbey_Text_Display.gif`} alt="Text Diplay" />
